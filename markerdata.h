...
public:
  ...
  /*
    ...
    noise.
    */
  int vPoint; ///< Where we are if following virtual data.
  QList<C3dFloatFrame*> vData; ///< Virtual marker data
  QList<C3dFloatFrame*> shadowData; ///< Perturbed copy of vData

  bool vMarkers; ///< Should we draw marker data from the virtual source?
